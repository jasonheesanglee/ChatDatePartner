...
class Prompts:
    ...
    def gender_translator(self, gender):
        '''
        Translate genders in Korean to English string.
        :param gender: Genders in Korean
        :return: Genders in English
        '''
        if '여자' in gender:
            return 'female'
        elif '남자' in gender:
    ...
    def get_traits(self) -> str:
        '''
        Prepares characteristics of the Chatbot.
        :return: Characteristics of the Chatbot. -> string
        '''
        trait = f'''
    ...
    def get_speech(self) -> str:
        '''
        Prepares the example speech of the Chatbot.
        :return: The example speech of the Chatbot. -> string
        '''
        speech = f'''
    ...
    def get_five_factor_model(self) -> str:
        '''
        Prepares Five Factor Model for the Chatbot.
        :return: Five Factor Model for the Chatbot. -> string
        '''
        ffm = '''
        five factor model :
        Openness : {self.gaebang}%
